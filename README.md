...
> Актуальная документация Bitrix24 REST API: https://apidocs.bitrix24.ru/

1. **Создайте входящий вебхук в вашем облачном портале Bitrix24.**
   * Выдайте вебхуку права как минимум `crm` (минимально необходимый доступ для этого MCP сервера).
   * Скопируйте URL вида:
...
### Развертывание (быстрая проверка запуска)

Минимальная последовательность для развёртывания в текущей сессии:
